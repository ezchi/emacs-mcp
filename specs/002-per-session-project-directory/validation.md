...
| AC-2 | PASS | Test `emacs-mcp-test-protocol-set-project-dir`: confirms slot changes. Test `emacs-mcp-test-protocol-set-project-dir-path-auth`: verifies path authorization respects new dir. Test `emacs-mcp-test-protocol-deferred-project-dir`: verifies `emacs-mcp--current-project-dir` bound at dispatch. |
...
| AC-6 | PASS | Test `emacs-mcp-test-protocol-set-project-dir-hook`: hook fires on actual change with correct args; does NOT fire on same-directory call. |
